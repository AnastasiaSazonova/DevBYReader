...
- (NSArray *)getCommentsList
{
    NSArray *commentsList = @[
                            ...
                            [Comment dataObjectWithAuthor:@"author3" andTime:@"10 апреля в 17:31" andText:@"Heartbleed – новое слово в маркетинге багов" andDepth:1],
                            [Comment dataObjectWithAuthor:@"author4" andTime:@"10 апреля в 16:44" andText:@"Злой гений создал гибрид '2048' и 'Flappy Bird' на погибель вашей продуктивности" andDepth:1],
                            ...
                            [Comment dataObjectWithAuthor:@"author6" andTime:@"09 апреля в 10:46" andText:@"Фотоотчет с IT Spring 2014: Люди, лего и город в лучах заката" andDepth:0],
                            [Comment dataObjectWithAuthor:@"author66" andTime:@"09 апреля в 10:46" andText:@"Фотоотчет с IT Spring 2014: Люди, лего и город в лучах заката" andDepth:1],
                            [Comment dataObjectWithAuthor:@"author1" andTime:@"14 апреля в 11:06" andText:@"Шесть парадигм программирования, которые изменят ваше представление о коде" andDepth:2],
                            [Comment dataObjectWithAuthor:@"author2" andTime:@"11 апреля в 15:26" andText:@"Михаил Дубаков рассказал и показал десятилетнюю историю TargetprocessМихаил Дубаков рассказал и показал десятилетнюю историю TargetprocessМихаил Дубаков рассказал и показал десятилетнюю историю Targetprocess" andDepth:3],
